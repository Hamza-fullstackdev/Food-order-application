...
class AssetsPath {
  ...
  static const String decorationImg1 = '${baseUrl}circle_img1.png';
  static const String decorationImg2 = '${baseUrl}circle_img2.png';

  static const String dummyCard = '${baseUrl}dummy_card.png';
  static const String foodImg = '${baseUrl}food_img.jpg';

  static const String cashCard = '${baseUrl}cash.png';
  static const String visaCard = '${baseUrl}visa.png';
  static const String paypalCard = '${baseUrl}paypal.png';
  static const String masterCard = '${baseUrl}master_card.png';

  

  static const String paymentSuccess = '${baseUrl}payment_success.jpg';
